...
public class Model {
	...
	private SimpleDirectedGraph<Sighting, DefaultEdge> graph;
	private SimpleDirectedGraph<String, DefaultEdge> graph2;
...
//		if(ListStati==null) 	ListStati=dao.getStati(anno) ;					 			
//		System.out.println(ListStati );
//		return ListStati;
//	}

	public void  creaGrafo(int anno) {
		String s="";
		if(graph==null)		this.graph = new SimpleDirectedGraph<>(DefaultEdge.class);
 ...
 */
	...
	public List<Sighting> trovaSucessori(Sighting s) {
		List<Sighting> successori = new ArrayList<Sighting>();
			successori.addAll(Graphs.predecessorListOf(graph,s));		
		return successori;
	}
 ...
 */
	...
	{	
		...
		{
			Sighting c1 = visita.next(); //Prendo il successore
			vicini.add(c1); //e lo metto nella lista
		}
		return vicini;
	}
